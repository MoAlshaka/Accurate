        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('shipment-transactions.update', ['shipment_transaction' => $shipmentTransaction->id]) }}"
                        ...
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    <input class="form-control" name="code" placeholder="الكود" required=""
                                        value="{{ $shipmentTransaction->code }}" type="text">
                                </div>
                                @error('code')
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <input class="form-control" name="name" placeholder="الاسم" required=""
                                        value="{{ $shipmentTransaction->name }}" type="text">
                                </div>
                                @error('name')
                                    <div class="tx-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="parsley-select col-lg-6 col-md-8" id="slWrapper">
                                <select class="form-control select1" data-placeholder="المستند " required=""
                                    name="document">
                                    <option value="{{ $shipmentTransaction->document }}">
                                        {{ $shipmentTransaction->document }}
                                    </option>
                                    <option value="--">-- </option>
                                    <option value="--">-- </option>
                                    <option value="--">-- </option>
                            ...
                            <div class="parsley-select col-lg-6 col-md-8" id="slWrapper">
                                <select class="form-control select1" data-placeholder="المسلسل " required=""
                                    name="sersies">
                                    <option value="{{ $shipmentTransaction->sersies }}">
                                        {{ $shipmentTransaction->sersies }}
                                    </option>
                                    <option value="--">-- </option>
                                    <option value="--">-- </option>
                                    <option value="--">-- </option>
                            ...
                            <div class="parsley-select col-lg-6 col-md-8 mg-lg-t-20" id="slWrapper">
                                <select class="form-control select1" data-placeholder="اختر الفرع" required=""
                                    name="branch_id">
                                    <option value="{{ $shipmentTransaction->branch->id }}">
                            ...
                            <div class="parsley-select col-lg-6 col-md-8 mg-lg-t-20" id="slWrapper">
                                <select class="form-control select1" data-placeholder="حساب الاستاذ " required=""
                                    ...
                                    <option value="{{ $shipmentTransaction->personal_account }}">
                                        {{ $shipmentTransaction->personal_account }}
                                    </option>
                                    <option value="--">-- </option>
                                    <option value="--">-- </option>
                                    <option value="--">-- </option>
                            ...
                            <div class="parsley-select col-lg-6 col-md-8 mg-lg-t-20" id="slWrapper">
                                <select class="form-control select1" data-placeholder="أنولع القيد المحاسبى " required=""
                                    ...
                                    <option value="{{ $shipmentTransaction->journalType->id }}">
                                        {{ $shipmentTransaction->journalType->name }}
                                    </option>
                                    @isset($journalTypes)
                            ...
                            <div class="parsley-select col-lg-6 col-md-8 mg-lg-t-20" id="slWrapper">
                                <select class="form-control select1" data-placeholder="اليومية المساعدة " required=""
                                    name="subsidiary_id">
                                    <option value="{{ $shipmentTransaction->subsidiary->id }}">
                                        {{ $shipmentTransaction->subsidiary->name }}
                                    </option>
                                    @isset($subsidiaries)
