            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0"> قوائم أسعار الشحن</h4>
                        <a href="{{ route('price-list.create') }}" class="btn ripple btn-primary text-white btn-icon"
                                    ...
                                    @foreach ($priceLists as $priceList)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('price-list.edit', ['price_list' => $priceList->id]) }}"
                                                ...
                                                <form
                                                    action="{{ route('price-list.destroy', ['price_list' => $priceList->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
