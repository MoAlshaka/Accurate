            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">المندوبين</h4>
                        <a href="{{ route('agents.create') }}" class="btn ripple btn-primary text-white btn-icon"
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0">خط السير</th>
                                    <th class="wd-10p border-bottom-0">فعال</th>
                                    <th class="wd-15p border-bottom-0"> سداد العمولة اليا</th>
                                    ...
                                    @foreach ($agents as $agent)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('agents.destroy', ['agent' => $agent->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
