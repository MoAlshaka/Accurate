            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">الخزينة</h4>
                        <a href="{{ route('safes.create') }}" class="btn ripple btn-primary text-white btn-icon"
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">أمناء الخزينة</th>
                                    <th class="wd-10p border-bottom-0"> فعال</th>
                                    <th class="wd-10p border-bottom-0"> إيداع</th>
                                    <th class="wd-10p border-bottom-0"> سحب</th>
                                    <th class="wd-10p border-bottom-0"> تحويل وارد</th>
                                    <th class="wd-10p border-bottom-0"> تحويل صادر</th>
                                    ...
                                    @foreach ($safes as $safe)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('safes.edit', ['safe' => $safe->id]) }}"
                                                ...
                                                <form action="{{ route('safes.destroy', ['safe' => $safe->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
