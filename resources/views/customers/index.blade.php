            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('customers.create') }}" class="btn ripple btn-primary text-white btn-icon"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    <th class="wd-10p border-bottom-0">اسم المتجر</th>
                                    <th class="wd-10p border-bottom-0">الاسم</th>
                                    <th class="wd-10p border-bottom-0">الكود</th>
                                    <th class="wd-10p border-bottom-0">المستحق</th>
                                    <th class="wd-10p border-bottom-0">تاريخ الإنشاء</th>
                                    <th class="wd-20p border-bottom-0"> المصدر</th>
                                    <th class="wd-10p border-bottom-0">الفرع</th>
                                    <th class="wd-10p border-bottom-0">رقم التلفون</th>
                                    <th class="wd-15p border-bottom-0">رقم الموبيل</th>
                                    <th class="wd-10p border-bottom-0">البريد الالكترونى</th>
                                    <th class="wd-10p border-bottom-0"> مفعل</th>
                            ...
                            <tbody>
                                @isset($customers)
                                    @foreach ($customers as $customer)
                                        <tr>
                                            <td>{{ $customer->name }}</td>
                                            <td>{{ $customer->company_representative }}</td>
                                            <td>{{ $customer->code }}</td>
                                            <td>--</td>
                                            <td>{{ $customer->created_at }}</td>
                                            <td>{{ $customer->city }}-{{ $customer->zone }}</td>
