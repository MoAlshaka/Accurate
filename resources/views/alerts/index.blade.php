            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0"> رسائل الادارة </h4>
                        <a href="{{ route('alerts.create') }}" class="btn ripple btn-primary text-white btn-icon"
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p border-bottom-0">محتوى الرسالة </th>
                                    <th class="wd-10p border-bottom-0"> النوع</th>
                                    <th class="wd-10p border-bottom-0"> وسائل التنبية</th>
                                    <th class="wd-10p border-bottom-0">تاريخ الانشاء</th>
                                    <th class="wd-10p border-bottom-0">تاريخ الارسال</th>
                                    ...
                                    @foreach ($alerts as $alert)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('alerts.destroy', ['alert' => $alert->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
