        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('support-cates.update', ['support_cate' => $supportCate->id]) }}"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="name" placeholder="الاسم" required=""
                                        type="text" value="{{ $supportCate->name }}">
                                </div>
                                @error('name')
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="code" placeholder="الكود" required=""
                                        type="text" value="{{ $supportCate->code }}">
                                </div>
                                @error('code')
                                    <div class="tx-danger">{{ $message }}</div>
                                @enderror
