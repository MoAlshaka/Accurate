            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">الشحنات</h4>
                        <a href="{{ route('shipments.create') }}" class="btn ripple btn-primary text-white btn-icon"
                                ...
                                @isset($shipments)
                                    @foreach ($shipments as $shipment)
                                        <tr>
                                            ...
                                            <td>--</td>
                                            <td>{{ $shipment->sender_city }}-{{ $shipment->sender_zone }}</td>
                                            <td>{{ $shipment->receiver_name }}</td>
                                            <td>{{ $shipment->receiver_city }}-{{ $shipment->receiver_zone }}</td>
                                            <td>
