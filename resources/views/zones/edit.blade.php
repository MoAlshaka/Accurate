        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('zones.update', ['zone' => $zone->id]) }}" data-parsley-validate=""
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" name="zone_code" placeholder="الكود" required=""
                                        type="text" value="{{ $zone->zone_code }}">
                                </div>
                            </div>
                            @error('zone_code')
                            ...
                            <div class="parsley-select col-lg-6 col-md-8" id="slWrapper">
                                ...
                                <select class="form-control select2" data-parsley-class-handler="#slWrapper"
                                    ...
                                    <option value="{{ $zone->branch->id }}">
                                        {{ $zone->branch->branch_name }}
                                    </option>
                                    @isset($branches)
