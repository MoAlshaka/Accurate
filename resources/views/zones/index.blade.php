            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">الأقاليم و المناطق</h4>
                        <a href="{{ route('zones.create') }}" class="btn ripple btn-primary text-white btn-icon"
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0">الفرع</th>
