            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('agent-commission.create') }}" class="btn ripple btn-primary text-white btn-icon"
                                ...
                                @isset($commissions)
                                    @foreach ($commissions as $commission)
                                        <tr>
                                            ...
                                            <td>{{ $commission->desc }}</td>
                                            <td>
                                                {{-- <div class="main-contact-action btn-list pt-3 pr-3"> --}}
                                                <a href="{{ route('agent-commission.edit', ['agent_commission' => $commission->id]) }}"
                                                ...
                                                <form
                                                    action="{{ route('agent-commission.destroy', ['agent_commission' => $commission->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
