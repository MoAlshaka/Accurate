            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0"> فريق الدعم </h4>
                        <a href="{{ route('teams.create') }}" class="btn ripple btn-primary text-white btn-icon"
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p border-bottom-0"> اقسام الدعم</th>
                                    <th class="wd-20p border-bottom-0"> الاعضاء</th>
