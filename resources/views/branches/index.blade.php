            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('branches.create') }}" class="btn ripple btn-primary text-white btn-icon"
