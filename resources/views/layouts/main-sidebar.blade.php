...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">الشحن</li>
            <li class="slide">
            ...
            <li class="slide">
                {{-- <a href="{{ route('alrets.index') }}"> --}}
                <a class="side-menu__item" href="{{ route('alerts.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path d="M15 11V4H4v8.17l.59-.58.58-.59H6z" opacity=".3" />
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">رسائل
                        الإدارة</span></a>
                {{-- </a> --}}
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('shipments.index') }}">قائمة الشحنات</a></li>
                    <li><a class="slide-item" href="{{ route('shipments.create') }}">إنشاء شحنة</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">حركة الشحنات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">نحميل من إكسيل</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">شحنات فى المخزن</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">جرد المخزن</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">قيد التوصيل /
                            الإلتقاط</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">شحنات لم نسلم</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">تفريغ محتوى الشحنة</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الباركود</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">طلبات الإلتقاط</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('pickups.index') }}">قائمة طالبات الالتقاط</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('pickups.create') }}">إنشاء طلب التقاط</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">التحويل بين الفروع</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">العمليات اليومية</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('pkms.index') }}">قوائم الإلتقاط</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">العمليات المالية</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('customers.create') }}">إنشاء عميل</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = '#')) }}">الحسبات المسجلة</a></li>
                    <li><a class="slide-item" href="{{ route('price-list.index') }}"> قوائم أسعار الشحن</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = '#')) }}"> قيد التسويه مع العملاء</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">مندوبى النوصيل</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('agents.index') }}">قائمة المندوبين </a>
                    </li>
                    <li><a class="slide-item" href="{{ route('agents.create') }}"> إنشاء مندوب</a></li>
                    <li><a class="slide-item" href="{{ route('agent-commission.index') }}"> قوائم عمولات
                            المندوبين</a></li>
                    <li><a class="slide-item" href="{{ route('routes.index') }}"> خطوط سير المندوبين</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'map-leaflet')) }}"> فيد التسوية مع
                            المندوبين</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'map-vector')) }}"> تحركات المندوبين</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">التخزين</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">التعريفات الأساسية</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('company.index') }}">بيانات الشركة</a></li>
                    <li><a class="slide-item" href="{{ route('branches.index') }}">الفروع</a></li>
                    <li><a class="slide-item" href="{{ route('zones.index') }}">الأقاليم و المناطق</a></li>
                    <li><a class="slide-item" href="{{ route('shipping-services.index') }}">خدمات الشحن </a></li>
                    <li><a class="slide-item" href="{{ route('cancellation-reasons.index') }}">أسباب الإلغاء</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('shipment-transactions.index') }}"> أنواع الحركات</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('safes.index') }}"> الخزائن</a></li>
                    <li><a class="slide-item" href="{{ route('warehouses.index') }}">أقسام المخازن</a></li>
                    <li><a class="slide-item" href="{{ route('subsidiaries.index') }}">اليومية المساعدة </a></li>
                    <li><a class="slide-item" href="{{ route('journal-types.index') }} "> أنواع القيد المحاسبى</a>
                    </li>
                </ul>
            </li>
            <li class="slide ">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الدعم الفنى</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('tickets.index') }}">الشكاوى</a></li>
                    <li><a class="slide-item" href="{{ route('support-cates.index') }}">أقسام الدعم</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('teams.index') }}">فريق الدعم</a></li>
                </ul>
            </li>
            <li class="slide ">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M20 13H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zm-1 6H5v-4h14v4zm-12-.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zM20 3H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zm-1 6H5V5h14v4zM7 8.5c.83 0 1.5-.67 1.5-1.5S7.83 5.5 7 5.5 5.5 6.17 5.5 7 6.17 8.5 7 8.5z" />
                    </svg><span class="side-menu__label">طلبات العملاء</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li class="sub-slide">
            ...
            <li class="slide ">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M20 13H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zm-1 6H5v-4h14v4zm-12-.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zM20 3H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zm-1 6H5V5h14v4zM7 8.5c.83 0 1.5-.67 1.5-1.5S7.83 5.5 7 5.5 5.5 6.17 5.5 7 6.17 8.5 7 8.5z" />
                    </svg><span class="side-menu__label">الأمان</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li class="sub-slide">
                        <a class="sub-side-menu__item" data-toggle="sub-slide"
                            href="{{ url('/' . ($page = '#')) }}"><span class="sub-side-menu__label">Level1</span><i
